 ...
 * Date: 19 Sept 2007
 * SVN: $Id: gazebo_ros_time.h 329 2011-05-17 09:39:57Z ricardo $
 */
#ifndef GAZEBO_ROS_TIME_HH
#define GAZEBO_ROS_TIME_HH
...
/**
    ...
    \brief ROS Time Controller
      ...
      \li broadcast simulator time over roslib::Clock.
      \li Example Usage:
          \verbatim
            <model:physical name="robot_model1">
